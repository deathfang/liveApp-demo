...
var Zepto = function() {
    ...
    return S.matches = function(t, e) {
        ...
        return o && (r = O).appendChild(t), i = ~S.qsa(r, e).indexOf(t), o && O.removeChild(t), 
        i;
    }, C = function(t) {
        ...
        e = null; else {
            ...
            if (S.isZ(e)) return e;
            if (A(e)) r = k(e); else if (D(e)) r = [ e ], e = null; else if (l.test(e)) r = S.fragment(e.trim(), RegExp.$1, i), 
            e = null; else {
                if (i !== t) return n(i).find(e);
                r = S.qsa(a, e);
            }
    ...
    }, n.type = L, n.isFunction = Z, n.isWindow = $, n.isArray = A, n.isPlainObject = R, 
    n.isEmptyObject = function(t) {
        ...
        var n, r, o, i = [];
        if (M(t)) for (r = 0; r < t.length; r++) n = e(t[r], r), null != n && i.push(n); else for (o in t) n = e(t[o], o), 
        null != n && i.push(n);
        return z(i);
    }, n.each = function(t, e) {
        var n, i;
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function(t) {
    ...
    function g(t, e, n, i) {
        ...
        n.success.call(r, t, o, e), i && i.resolveWith(r, [ t, o, e ]), h(n, r, "ajaxSuccess", [ e, n, t ]), 
        y(o, e, n);
    }
    function v(t, e, n, i, r) {
        var o = i.context;
        i.error.call(o, n, e, t), r && r.rejectWith(o, [ n, e, t ]), h(i, o, "ajaxError", [ n, i, t || e ]), 
        y(e, n, i);
    }
    function y(t, e, n) {
        var i = n.context;
    ...
    t.active = 0, t.ajaxJSONP = function(i, r) {
        ...
        n.url || (n.url = window.location.toString()), E(n), n.cache === !1 && (n.url = w(n.url, "_=" + Date.now()));
        ...
        l("Accept", u || "*/*"), (u = n.mimeType || u) && (u.indexOf(",") > -1 && (u = u.split(",", 2)[0]), 
        d.overrideMimeType && d.overrideMimeType(u)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && l("Content-Type", n.contentType || "application/x-www-form-urlencoded"), 
        n.headers) for (r in n.headers) l(r, n.headers[r]);
...
!function() {
    ...
    function c(c, d) {
        function e(a) {
            return m += a.split(/\n/).length - 1, k && (a = a.replace(/\s+/g, " ").replace(/<!--.*?-->/g, "")), 
            a && (a = s[1] + b(a) + s[2] + "\n"), a;
        }
        function f(b) {
            var c = m;
    ...
    e.parser = function(a, b) {
        ...
        return a;
    }, "function" == typeof define ? define("dist/view/library/init_mobile", [], function() {
        return d;
...
!function() {
    ...
    a({
        ...
        if (!d) return "";
        var e, f;
        (f = d.match(/^(\w+)!(.+)$/)) && b(f[1]) ? (e = f[1], d = f[2]) : (f = d.match(/[^?]+(\.\w+)(?:\?|#|$)/)) && (e = c(f[1])), 
        e && -1 === d.indexOf("#") && (d += "#");
...
!function() {
    ...
    seajs.importStyle = function(e, f) {
        if (!f || (f = f.replace(b, "-"), !c.getElementById(f))) {
            var g;
            if (!a || f ? (g = c.createElement("style"), f && (g.id = f), d.appendChild(g)) : g = a, 
            void 0 !== g.styleSheet) {
    ...
    }, define("dist/view/library/init_mobile", [], {});
}();
